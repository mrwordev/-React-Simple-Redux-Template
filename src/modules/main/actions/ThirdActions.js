...
/* Normal Ation */
export const buttonToggle = () => ({ type: constant.THIRD_BUTTON_CLICK });
export const valueIncrease = () => ({
  type: constant.THIRD_VALUE_INCREASE
});
export const valueDecrease = () => ({
  type: constant.THIRD_VALUE_DECREASE
});
...
export const changeValueByPage = (value, page) => (
  ...
  dispatch({ type: action, value: value + 3 });
};
