...
/* Normal Ation */
export const buttonToggle = () => ({ type: constant.SECOND_BUTTON_CLICK });
export const valueIncrease = () => ({
  type: constant.SECOND_VALUE_INCREASE
});
export const valueDecrease = () => ({
  type: constant.SECOND_VALUE_DECREASE
});
...
export const changeValueByPage = (value, page) => (
  ...
  dispatch({ type: action, value: value + 2 });
};
